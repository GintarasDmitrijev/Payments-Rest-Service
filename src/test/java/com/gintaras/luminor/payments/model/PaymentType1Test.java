...
/**
 * JUnit test for {@link PaymentType1}
 *
 * @created 20/08/2020 - 4:06 PM
 * @author gintaras
 */

class PaymentType1Test {
    ...
    @Test
    void testToString() {
        PaymentType1 paymentType = new PaymentType1(AMOUNT_1_USD, IBAN, IBAN, DETAILS_TEXT);
    ...
    void determineCancellationFeeShouldReturnZeroFee() {
        PaymentType1 paymentType = new PaymentType1(AMOUNT_1_USD, IBAN, IBAN, LocalDateTime.now());
    ...
    void determineCancellationFeeShouldReturnZeroDotZeroFiveFee() {
        PaymentType1 paymentType = new PaymentType1(AMOUNT_1_USD, IBAN, IBAN, LocalDateTime.now().minusHours(1));
