...
/**
 * JUnit test for {@link Type3PaymentType}
 *
 * @created 20/08/2020 - 7:16 PM
 * @author gintaras
 */
class Type3PaymentTypeTest {
    ...
    @Test
    void testToString() {
        Type3PaymentType paymentType = new Type3PaymentType(AMOUNT_1_USD, IBAN, IBAN, BIC);
    ...
    void determineCancellationFeeShouldReturnZeroFee() {
        Type3PaymentType paymentType = new Type3PaymentType(AMOUNT_1_USD, IBAN, IBAN, LocalDateTime.now());
    ...
    void determineCancellationFeeShouldReturn_0_15_Fee() {
        Type3PaymentType paymentType = new Type3PaymentType(AMOUNT_1_USD, IBAN, IBAN, LocalDateTime.now().minusHours(1));
